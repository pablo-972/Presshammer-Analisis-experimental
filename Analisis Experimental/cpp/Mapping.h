...
/**
 * class to decode address mappings
 * Blacksmith code: https://github.com/comsec-group/blacksmith
 */
...
class Mapping {
    ...
    struct MemConfiguration dualRank = {
    ...
    public:
        ...
        int getRow();
        void incrementRow();
        void incrementColumnDw();
        void incrementColumnCb();
        void incrementBank();
        void decrementRow();
        void resetColumn();
        int linearize();
        uintptr_t toVirt();
        void decodeNewAddress(uintptr_t addr);
